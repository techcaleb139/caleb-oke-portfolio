        ...
        <section className="shell section" id="work">
          ...
          <article className="caseCard">
            ...
            <figure className="caseVisualWrapper">
              <Image
                src="/voice-ordering-case-study.webp"
                alt="Mama Tee's Voice AI Ordering System architecture schematic featuring Vapi call intake, n8n webhook routing, and Google Sheets synchronization"
                width={1536}
                height={864}
          ...
          <article className="caseCard">
            ...
            <figure className="caseVisualWrapper">
              <Image
                src="/job-pipeline-case-study.webp"
                alt="Automated Job Search and Intelligence Pipeline diagram showing multi-source API ingestion, n8n schema normalization, regex boundary filtering, and Telegram alert delivery"
                width={1536}
                height={864}
                sizes="(max-width: 900px) 100vw, 1200px"
              />
          ...
          <div className="aboutCard">
            <div className="aboutPortraitBox">
              <Image
                ...
                alt="Caleb Oke, AI Automation Engineer"
                width={680}
                height={680}
                priority
              />
